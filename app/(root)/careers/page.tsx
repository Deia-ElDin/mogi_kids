...
const Careers = () => {
  return (
    <section>
      ...
      <Text text="Are you looking for a rewarding and exciting career in child care? Sitters Child Care Services is a team of the best in home child care providers, caregivers, and newborn care providers in UAE. We also have a great administrative team that supports our providers in our mission to deliver the highest quality child care in the UAE.
