...
export const quoteData = [
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 1), 9),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 1), 15),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 2), 3),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 2), 7),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 3), 18),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
  ...
  },
  {
    ...
    email: "deia.tech2021@gmail.com",
    from: addMonths(today, 1),
    to: addDays(addMonths(today, 4), 5),
    numberOfHours: String(Math.floor(Math.random() * 24) + 1),
    numberOfKids: "8",
    ageOfKidsFrom: "4",
    ageOfKidsTo: "7",
